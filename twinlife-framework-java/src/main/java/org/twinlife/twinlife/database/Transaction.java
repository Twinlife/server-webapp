...
public class Transaction implements Closeable {
    ...
    public boolean storeAvatar(@NonNull TwincodeOutboundImpl twincodeOutboundImpl,
        ...
        if (image.value instanceof ExportedImageId) {
            twincodeOutboundImpl.setAvatarId(((ExportedImageId) image.value).getExportedId());
            ...
            if (id == null) {
                ...
                UUID currentAvatarId = twincodeOutboundImpl.getAvatarId();
                if (currentAvatarId != null && currentAvatarId.equals(avatarId)) {
                    return false;
                }
            }
            twincodeOutboundImpl.setAvatarId(avatarId);
        }
        return true;
    }
