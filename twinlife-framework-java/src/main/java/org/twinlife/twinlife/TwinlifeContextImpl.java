...
import org.twinlife.twinlife.Twinlife.TwinlifeConfiguration;
...
public class TwinlifeContextImpl implements TwinlifeContext {
    ...
    public void onServiceConnected(@NonNull TwinlifeImpl twinlifeImpl) {
        ...
        mTwinlifeExecutor.execute(() -> configure(mTwinlifeImpl.getConnection()));
    }

    private void configure(@NonNull Connection connection) {
        if (DEBUG) {
