...
public class TwincodeOutboundServiceImpl extends BaseServiceImpl<TwincodeOutboundService.ServiceObserver> implements TwincodeOutboundService {
    ...
    public void updateTwincode(@NonNull TwincodeOutbound twincodeOutbound,
        ...
        if (isSigned) {
            ...
            signature = null; // mCryptoService.sign(twincodeOutbound, finalAttributes);
            if (signature == null) {
...
*/
    ...
    private void onGetTwincode(@NonNull BinaryPacketIQ iq) {
        ...
        if (request instanceof GetTwincodePendingRequest) {
            ...
            final TwincodeOutbound twincodeOutbound;
            if (ENABLE_DATABASE) {
                twincodeOutbound = mServiceProvider.importTwincode(getRequest.twincodeId, attributes,
                ...
                twincodeOutbound = new TwincodeOutboundImpl(null, getRequest.twincodeId, 0, modificationDate, attributes);
                getRequest.complete.onGet(ErrorCode.SUCCESS, twincodeOutbound);
            }
        } else {
    ...
    private void onUpdateTwincode(@NonNull BinaryPacketIQ iq) {
        ...
        if (ENABLE_DATABASE) {
            ...
            twincodeOutbound.importAttributes(request.attributes, modificationDate, null);
        }
...
*/
    ...
    protected void onErrorPacket(@NonNull BinaryErrorPacketIQ iq) {
        ...
        if (request instanceof GetTwincodePendingRequest) {
            ...
            if (iq.getErrorCode() == ErrorCode.ITEM_NOT_FOUND && !ENABLE_DATABASE) {
