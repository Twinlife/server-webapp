...
public class TwincodeFactoryImpl implements TwincodeFactory {
    ...
    public TwincodeFactoryImpl(@NonNull UUID id, long modificationDate, @NonNull TwincodeInbound twincodeInbound,
    ...
    public TwincodeFactoryImpl(@NonNull UUID id, long modificationDate, @NonNull UUID twincodeInboundId,
                               @NonNull UUID twincodeOutboundId, @NonNull UUID twincodeSwitchId,
                               @NonNull List<AttributeNameValue> attributes) {

        mId = id;
        mModificationDate = modificationDate;
        mTwincodeOutbound = new TwincodeOutboundImpl(null, twincodeOutboundId, modificationDate,
                "", null, null, null, null, 0);
        mTwincodeInbound = new TwincodeInboundImpl(null, twincodeInboundId, id, mTwincodeOutbound, null,
