...
public class TwincodeOutboundImpl extends DatabaseObjectImpl implements TwincodeOutbound {
    ...
    public TwincodeOutboundImpl(@NonNull DatabaseIdentifier id, @NonNull UUID twincodeId, long modificationDate,
                                @Nullable String name, @Nullable String description, @Nullable UUID avatarId,
    ...
    public TwincodeOutboundImpl(@NonNull DatabaseIdentifier id, @NonNull UUID twincodeId, int flags, long modificationDate,
    ...
    public synchronized void setAvatarId(@Nullable UUID avatarId) {

        mAvatarId = avatarId;
    }

    synchronized void update(long modificationDate, @Nullable String name, @Nullable String description,
                             @Nullable UUID avatarId, @Nullable String capabilities, @Nullable byte[] content, int flags) {
            ...
            for (AttributeNameValue attribute : attributes) {
                switch (attribute.name) {
                    ...
                    case Twincode.AVATAR_ID:
                        if (attribute.value instanceof UUID) {
                            mAvatarId = (UUID) attribute.value;
                        } else {
                            mAvatarId = Utils.toUUID(String.valueOf(attribute.value));
                        }
                        break;
                    default:
                        boolean found = false;
