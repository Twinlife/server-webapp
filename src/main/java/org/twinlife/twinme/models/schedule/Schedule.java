...
@JsonIgnoreProperties({ "schemaId", "enabled", "id", "name", "nowInRange", "private", "schemaVersion", "serializer" })
public class Schedule {
    ...
    private Schedule(@NonNull UUID id, @NonNull UUID schemaId, int schemaVersion, long creationDate, @NonNull String serializer,
                     @NonNull String name, boolean isPrivate, @NonNull TimeZone timeZone, @NonNull List<TimeRange> timeRanges) {
        mId = id;
        mSchemaId = schemaId;
